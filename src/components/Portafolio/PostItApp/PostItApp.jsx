        ...
        <div className="card rgb">
            ...
            <div onClick={() => window.open('https://profound-begonia-f76288.netlify.app/', '_blank')}
                ...
                <figure className="c4-izmir c4-border-ccc-2 c4-image-zoom-out c4-gradient-top ">
                    ...
                    <img className='bg_portafolio' src={Posit} alt="Social Media Imgane" />
                    <figcaption className='c4-layout-top-left'>
                        ...
                        <div className='icon_container'>
                            ...
                            <span className="icon is-small mx-1">
                                <img className='icon_img' src="https://upload.wikimedia.org/wikipedia/commons/6/61/HTML5_logo_and_wordmark.svg" alt="HTML5Logo" />
                            </span>
                            <span className="icon is-small mx-1">
                                <img className='icon_img' src="https://upload.wikimedia.org/wikipedia/commons/6/62/CSS3_logo.svg" alt="Css3Logo" />
                            </span>
                            <span className="icon is-small mx-1">
                                <img className='icon_img' src="https://upload.wikimedia.org/wikipedia/commons/6/6e/Svelte_logo_by_gengns.svg" alt="SvelteLogo" />
                            </span>
                        </div>
                    </figcaption>
