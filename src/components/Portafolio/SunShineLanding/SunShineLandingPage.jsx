        ...
        return (
            ...
            <div className="card rgb">
                ...
                <footer className="card-footer">
                    <a href="https://roaring-jelly-81eb51.netlify.app/" target="_blank" className="card-footer-item"><i className="fas fa-search" aria-hidden="true"></i>Preview</a>
                    <a href="https://github.com/aromero7764/landingPage" target="_blank" className="card-footer-item"><i className="fas fa-code" aria-hidden="true"></i>Source Code</a>
                </footer>
            </div>
